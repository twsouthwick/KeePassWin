...
[submitting pull requests](#pull-requests), but please **do not** derail or troll issues. Keep the discussion on topic and
...
>
> A summary of the issue device (mobile/desktop) and build of windows (i.e. Windows 1607)
> and a list of steps to reproduce; such as:
>
